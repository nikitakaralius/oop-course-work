...
%%
%%
\renewcommand{\thesisTitle}{Разработка приложения для анализа файловой системы}
...
\newcommand{\thesisDeadline}{16.12.2023}
\newcommand{\thesisStartDate}{04.10.2023}
\newcommand{\thesisYear}{2023}
%%
%%
\newcommand{\group}{5130903/20002} % заменить вместо N номер группы
\newcommand{\thesisSpecialtyCode}{}% код направления подготовки
\newcommand{\thesisSpecialtyTitle}{<<Технология объектно-ориентированного программирования>>} % наименование направления/специальности
